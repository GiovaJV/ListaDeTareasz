...
const incomplete = document.querySelector('#boton4');
  ...
  const renderTasks = () => {
    ...
    tasks.forEach(tarea => {
      ...
      li.id = tarea.id;
      li.innerHTML = `<button class="checkpositivo1"><i class="fa-solid fa-check" style="color: #21ef06;"></i></i></button>
      <p class="tareas">${tarea.tarea}</p>
      <button class="checknegativo1"><i class="fa-solid fa-trash"></i></button>`;
